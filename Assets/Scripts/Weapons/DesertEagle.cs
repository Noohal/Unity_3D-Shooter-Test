...
public class DesertEagle : MonoBehaviour, n_GunObject
{
    public string Name { get; set; } = "Desert Eagle";
    ...
    public int maximumAmmo { get; } = 35;

    public float damage { get; set; } = 53f;

    public float fireRate { get; set; }
    public float fireRateRPM { get; set; } = 267;
    public float fireRange { get; set; } = 25f;
    public float reloadTime { get; set; } = 2.2f;
